...
class AdapterString : RecyclerView.Adapter<AdapterString.StringViewHolder>(){
    ...
    class StringViewHolder(var root: View, val textView: TextView, val imagen: ImageView) : RecyclerView.ViewHolder(root)
    ...
    override fun onBindViewHolder(holder: StringViewHolder, position: Int) {
        cervezas?.let {
            ...
            holder.root.setOnClickListener{
                ...
                DetailsActivity.createDetailsActivity(holder.root.context , pos)
            }
        }
    }
